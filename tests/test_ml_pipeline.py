...
def test_pipeline_builds_without_error(spark):
    # `spark` fixture ensures an active SparkContext exists: build_pipeline()
    # constructs JVM-backed ML stages (StringIndexer, etc.) which require one.
