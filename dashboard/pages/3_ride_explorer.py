...
3_ride_explorer.py
-------------------
Dashboard page to explore individual cleaned rides with filters (date
range, passenger count, payment type, zone), reading ride-level data from
output/parquet/rides/ and rendering the matching rows in a table.
"""
